...
L_2=imread('take_1_L_2 33.jpg');
L_3=imread('take_1_L_2 34.jpg');
L_4=imread('take_1_L_2 35.jpg');
L_5=imread('take_1_L_2 36.jpg');

R_1=imread('take_1_R_2 32.jpg');
R_2=imread('take_1_R_2 33.jpg');
R_3=imread('take_1_R_2 34.jpg');
R_4=imread('take_1_R_2 35.jpg');
R_5=imread('take_1_R_2 36.jpg');
...
% figure(5)
% for i=1:239
%   scatter3(GD(i,8),GD(i,5),GD(i,7),'b');
%   hold on
% end
% xlabel('Z');
% ylabel('Y');
...
% 
% figure(7)
% scatter(1:89,GD(125:213,5),'r');
% 
% figure(8)
% scatter(1:89,GD(125:213,7),'b');
% 
% figure(9)
% scatter(1:89,GD(125:213,8),'k');
% 
% 
% 
figure(10)
...
% end
% 
% P1=polyfit(1:88,GP(1,1:88),1);
% PF = polyval(P1,1:88); 
% 
figure(3)
scatter(1:88,G(1:88,2),'k');
% hold on
% plot(1:88,PF);
% 
% GP=zeros(1,44);
...
% end
% 
% P2=polyfit(1:44,GP(1,1:44),1);
% PF = polyval(P2,1:44); 
% 
% figure(4)
% scatter(1:44,GP(1,1:44),'k');
% hold on
% plot(1:44,PF);
% 
...
L=zeros(1,3);
L(1,1)=(GD(85,6)+GD(86,6)+GD(87,6)+GD(88,6)+GD(89,6))/5;
L(1,2)=(GD(85,7)+GD(86,7)+GD(87,7)+GD(88,7)+GD(89,7))/5;
L(1,3)=(GD(85,8)+GD(86,8)+GD(87,8)+GD(88,8)+GD(89,8))/5;
